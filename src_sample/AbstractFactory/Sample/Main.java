...
public class Main {
    public static void main(String[] args) {
        if (args.length != 2) {
            ...
            System.out.println("Example 1: java Iterator.Main list.html listfactory.ListFactory");
            System.out.println("Example 2: java Iterator.Main div.html divfactory.DivFactory");
            System.exit(0);
        }
